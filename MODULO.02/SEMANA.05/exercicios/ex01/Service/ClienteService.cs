...
namespace BancoFullStack.Service
{
    public class ClienteService : IClienteService
    {
        ...
        {
            _clientes.Add(new PessoaFisica(3,"Rua Caminho de Fora ", "1254", "605", "Maria", new DateTime(1993,7,31)));
            _clientes.Add(new PessoaJuridica(6,"Rua Tubarão", "355", "807", "Vivv","3254"));
        }
